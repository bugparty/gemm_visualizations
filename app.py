"""
Interactive GEMM Memory Access Pattern Visualizer
...
server = app.server  # Expose the Flask server for Hugging Face
...
app.layout = html.Div([
    html.Div([
        ...
        html.P([
            "Made with ❤️ | ",
            html.A("GitHub", href="https://github.com/bugparty/gemm_visualizations", target="_blank"),
            " | ",
...
if __name__ == '__main__':
    ...
    print(f"🚀 Starting GEMM Interactive Visualizer on port {port}...")
